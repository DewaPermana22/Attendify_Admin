...
const colors : { [key in Props['color']]: string } = {
  ...
  Disabled : "bg-gray-200 text-text dark:text-textDark hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-600 dark:border-gray-700"
}
